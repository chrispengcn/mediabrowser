...
def main():
    ...
    parser.add_argument('--indent', type=int, default=None, help='JSON缩进空格数，默认不缩进（紧凑格式）')
    ...
    try:
        # 保存为紧凑格式的JSON（移除indent参数）
        with open(args.output, 'w', encoding='utf-8') as f:
            json.dump(file_structure, f, ensure_ascii=False, indent=args.indent)
